...
ArticleService.createArticle('anything', 'New Post Content', 'String');
ArticleService.patchArticle(137, {
    title: '바꿈',
    content: 'Good'
});
...
ProductService.createProduct('초콜릿', '두바이 초콜릿', 100000, ['초콜릿', '간식'], ['url']);
ProductService.patchProduct(89, {
    price: 111111
});
